...
public class Player : MonoBehaviour
{
    ...
    public void Movement()
    {
        ...
        if (Input.GetKeyDown(KeyCode.J) || Input.GetButton("XboxB") || CrossPlatformInputManager.GetButtonDown("shoot"))
        {
           ...
           // _GunAudio.Play();
            ...
            if (move > 0 || move1 > 0 || _PlayerSprite.flipX == false)
            {
            ...
            else if (move < 0 || move1 < 0 || _PlayerSprite.flipX == true)
            {
        ...
        if ((Input.GetKeyDown(KeyCode.Space) || Input.GetButton("XboxA") || verticalMove >= 0.5f) && isGrounded() == true)
        {
        ...
        _rigid.velocity = new Vector2((move1 + move) * _speed, _rigid.velocity.y);
        _PlayerAnim.Move(move1 + move);
    }
